...
namespace GuitarApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            inventory.AddGuitar("1", 1000, Builder.FENDER, "model1", Types.ACOUSTIC, 6, Wood.ADIRONDACK, Wood.ADIRONDACK);
            inventory.AddGuitar("2", 20500, Builder.COLLINGS, "model2", Types.ELECTRIC, 5,  Wood.ALDER, Wood.ALDER);
            inventory.AddGuitar("3", 20887, Builder.COLLINGS, "model2", Types.ELECTRIC, 5, Wood.ALDER, Wood.ALDER);
